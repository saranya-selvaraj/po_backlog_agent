...
Customer Satisfaction (CSAT) feedback indicates that users are dissatisfied because the current food scoring experience does not provide sufficient visibility into the **level of ultra-processing** in a product. While the overall food score helps customers make quick comparisons, it does not clearly communicate how highly processed a food is. Introducing **Ultra-Processing Levels** would provide customers with additional transparency, helping them understand whether a product has a low, moderate, or high level of ultra-processing alongside its existing food score.
